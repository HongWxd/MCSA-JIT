...
raw_task = 'python main.py -train -train_data data/{}/deepjit/{}_train_raw.pkl -dictionary_data data/{}/deepjit/{}_dict.pkl -save-dir snapshot/{}/raw -num_epochs {}'
task = 'python main.py -train -train_data data/{}/deepjit/{}_train.pkl -dictionary_data data/{}/deepjit/{}_dict.pkl -save-dir snapshot/{}/model -num_epochs {}'

raw_predict = "python main.py -predict -pred_data data/{}/deepjit/{}_test_raw.pkl -dictionary_data data/{}/deepjit/{}_dict.pkl -load_model snapshot/{}/raw/epoch_{}.pt"
predict = "python main.py -predict -pred_data data/{}/deepjit/{}_test.pkl -dictionary_data data/{}/deepjit/{}_dict.pkl -load_model snapshot/{}/model/epoch_{}.pt"
