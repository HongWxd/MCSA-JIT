...
def read_args():
    ...
    parser.add_argument('-code_line', type=int, default=32, help='the number of LOC in each hunk of commit code')
    ...
    parser.add_argument('-embedding_dim', type=int, default=16, help='the dimension of embedding vector')
